...
namespace DAL
{
	...
	public partial class User : ActiveRecord<User>, IActiveRecord
	{
		...
		public int? GoogleId 
		{
			get { return GetColumnValue<int?>(Columns.GoogleId); }
		...
		/// </summary>
		public static void Insert(int? varGoogleId,string varAvatar,string varEmail,string varDisplayName,string varUserName,string varPassword,DateTime? varAtCreate,int? varUserType,int? varStatus)
		{
			User item = new User();
		...
		/// </summary>
		public static void Update(int varId,int? varGoogleId,string varAvatar,string varEmail,string varDisplayName,string varUserName,string varPassword,DateTime? varAtCreate,int? varUserType,int? varStatus)
		{
			User item = new User();
