...
namespace DAL
{
    ...
    public partial class UserController
    {
	    ...
	    public void Insert(int? GoogleId,string Avatar,string Email,string DisplayName,string UserName,string Password,DateTime? AtCreate,int? UserType,int? Status)
	    {
		    User item = new User();
	    ...
	    public void Update(int Id,int? GoogleId,string Avatar,string Email,string DisplayName,string UserName,string Password,DateTime? AtCreate,int? UserType,int? Status)
	    {
		    User item = new User();
	        item.MarkOld();
	        item.IsLoaded = true;
